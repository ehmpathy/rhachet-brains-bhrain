...
/**
 * .what = fireworksai deepseek-v4-flash code generation integration tests for invokeBrainArch1
 ...
 */
describe.skip('invokeBrainArch1.fireworksai.codewrite.deepseek-v4-flash', () => {
  const getContext = () => ({
    creds: {
      anthropic: {
  ...
  given(
    '[case1] fireworksai deepseek-v4-flash with code generation from briefs',
    () => {
...
`;
            ...
            const toolTest = genBrainPlugToolDeclaration({
              ...
              schema: {
                ...
                output: z.object({
                  ...
                  stderr: z
                    .string()
                    .describe('Standard error from the command'),
            ...
            const config: BrainArch1Config = {
              atom: genAtomFireworks({ slug: 'fireworks/deepseek/v4-flash' }),
