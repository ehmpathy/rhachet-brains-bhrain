...
/**
 * .what = fireworksai m2.5 code generation integration tests for invokeBrainArch1
 ...
 */
describe.skip('invokeBrainArch1.fireworksai.codewrite.m25', () => {
  const getContext = () => ({
    creds: {
      anthropic: {
...
After you write it, use the test tool to verify it works with Austin, TX coordinates (--lat 30.2672 --lon -97.7431).`,
          ...
          logOutputHead({
            label: 'brainArch1.fireworksai.m25.codegen',
